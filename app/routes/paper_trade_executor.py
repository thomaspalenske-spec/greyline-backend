...
def run_paper_trade_executor():
    ...
    trade = ledger_engine.record_trade(
        ...
        trade_intent="BUY_CALL" if top_candidate.get("option_type") == "CALL" else "BUY_PUT" if top_candidate.get("option_type") == "PUT" else "UNKNOWN",
        bullish_score=top_candidate.get("bullish_score"),
        bearish_score=top_candidate.get("bearish_score"),
        opposing_score=top_candidate.get("opposing_score"),
        direction_confidence=top_candidate.get("direction_confidence"),
    )
