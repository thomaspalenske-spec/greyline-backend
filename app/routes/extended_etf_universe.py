"""The extended ETF universe — the scanned ETFs added as tracked candidates. Engine decides, this renders."""
...
def extended_etf_universe(sleeve: str = None):
    """The extended ETFs added to GreyLine's universe as TRACKED candidates (not armed). Pass ?sleeve=trend to see
