...
class ExtendedEtfShadowEngine:
    ...
    def mark(self):
        ...
        return {"status": "ETF_SHADOW_MARKED", "acted": bool(closed_now or opened),
    ...
    def open_positions(self):
        ...
        for co in cohorts:
            ...
            for leg in co.get("legs", []):
                ...
                rows.append({"symbol": leg["symbol"], "side": "BUY", "entry_date": co.get("opened"),
    ...
    def report(self):
        ...
        base = {"timestamp": datetime.utcnow().isoformat(), "shadow_enabled": self.enabled(),
                ...
                "note": ("ZERO-capital forward-test of the 52-ETF extended universe: rank by trailing return, "
                         "hold top-K a week, settle at live quotes, judged on the live edge court's bar. "
                         "NO orders/budget — how a new ETF earns its way toward a verdict.")}
        if n == 0:
