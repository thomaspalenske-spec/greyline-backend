...
class PaperTradeCandidateEngine:
    ...
    def build_ticket(self):
        ...
        dgl = DeploymentGovernanceLayer().score()

        candidate = decision.get("top_candidate", {})
        eligible = (
            candidate.get("result") == "WATCH"
        ...
        if not eligible:
            return {
                ...
                "reason": "No candidate eligible for paper trade promotion.",
                "decision": decision,
        ...
        ticket = {
            ...
            "recommended_position_size_pct": dgl.get("recommended_position_size_pct"),
