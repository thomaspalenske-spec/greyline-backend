...
class PriceHistoryStore:
    ...
    def price_at(self, symbol, target_timestamp, max_tolerance_seconds=3600):
        ...
        Returns {price, timestamp, age_seconds} or None if no point is close enough.
        """
        ...
        age = abs((best[0] - target).total_seconds())
        if age > max_tolerance_seconds:
            return None
        return {"price": best[1], "timestamp": best[0].isoformat(), "age_seconds": round(age, 1)}
